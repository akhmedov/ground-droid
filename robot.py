...
class Robot():
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.left_motor = [35,37]
        self.right_motor = [36,38]
        self.left_speed = 0
        self.right_speed = 0
    ...
    def dence(self, init_speed = 0):
        while init_speed < 0.99:
            self.forward(speed=init_speed)
            init_speed *= 2
            time.sleep(0.3)
        while init_speed > 0.01:
            self.forward(speed=init_speed)
            init_speed /= 2
            time.sleep(0.5)
        self.left(speed=0.3)
        time.sleep(2)
        self.right(speed=0.3)
        time.sleep(2)
        self.stop()
